...
function JerseyAvatar({ jersey }: { jersey: string }) {
  return (
    <div className="w-8 h-8 rounded-full bg-[#002147] border border-[#009EE0]/40 flex items-center justify-center shrink-0">
  ...
  return (
    <section className="bg-[#0e1f35]/90 backdrop-blur-sm rounded-2xl shadow-xl p-4">
      <div className="flex items-start justify-between mb-4 gap-4">
        ...
        <span className="text-xs text-gray-600 italic text-right">* Season totals — may include goals from previous clubs</span>
      </div>
